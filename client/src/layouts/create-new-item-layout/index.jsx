...
export const CreateNewItemLayout = ({
  children = null,
  methods = {},
  onSubmit = () => {},
  onError = () => {},
  ...
  const pathnames = useMemo(() => {
    return pathname
      ...
      .filter(Boolean)
      .map((item) => ({
        title: toCapitalize(item.replace(/[-]/gi, " ")),
        href: item,
      }));
  }, [pathname]);
...
export const getCreateNewItemLayout = (page) => {
  return <CreateNewItemLayout>{page}</CreateNewItemLayout>;
};
