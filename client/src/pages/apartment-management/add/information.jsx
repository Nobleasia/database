...
const Information = ({ available }) => {
  ...
  const { data: kodeProparData } = usePrivateFetcher(
    [process.env.NEXT_PUBLIC_ENDPOINT_APARTMENT_KODE_PROPAR_READ, {}],
    config
  )
  ...
  return (
    <>
      <ApartmentManagementGroupInput>
        <AddApartmentLabel htmlFor="kode_propar" isRequired>
          Kode Propar
        </AddApartmentLabel>
        <Controller
          control={control}
            ...
            return (
              <>
                <InputField
                  ...
                  type="text"
                  id="kode_propar"
                  placeholder="Apartment kode propar"
                ...
                {error ? (
                  ...
                  <ApartmentManagementCustomPlaceholder ariaPlaceholder="Example: AMP001">
                    Example: AMP001
                  </ApartmentManagementCustomPlaceholder>
                )}
              </>
      ...
      <ApartmentManagementGroupInput>
        <AddApartmentLabel htmlFor="name" isRequired>
          Name
        </AddApartmentLabel>
        <Controller
          control={control}
          ...
          render={({ field, fieldState: { isTouched, error } }) => (
            <>
              ...
              {error ? (
                ...
                <ApartmentManagementCustomPlaceholder ariaPlaceholder="Example: AMP-001">
                  Example: Ampera Apartment
                </ApartmentManagementCustomPlaceholder>
              )}
            </>
          )}
      ...
      <GroupInput direction="column" className="md:w-[384px] md:min-w-max">
        <AddApartmentLabel htmlFor="address">Address</AddApartmentLabel>
        <Controller
          control={control}
          name="address"
          rules={{
      ...
      {propertyAreaData?.data?.attributes.length > 0 && (
        <ApartmentManagementGroupInput>
          <AddApartmentLabel htmlFor="property_area" isRequired>
            Property Area
          </AddApartmentLabel>
      ...
      <ApartmentManagementGroupInput>
        <AddApartmentLabel htmlFor="available">Availability</AddApartmentLabel>
      ...
      <ApartmentManagementGroupInput>
        <AddApartmentLabel htmlFor="pic.fullname" isRequired>
          PIC Name
        </AddApartmentLabel>
      ...
      {!picFullnameIsExist && (
        <>
          <ApartmentManagementGroupInput>
            <AddApartmentLabel htmlFor="pic.phone_number" isRequired>
              PIC Phone Number
            </AddApartmentLabel>
            <Controller
              control={control}
          ...
          <ApartmentManagementGroupInput>
            <AddApartmentLabel htmlFor="pic.company" isRequired>
              PIC Company
            </AddApartmentLabel>
          ...
          <ApartmentManagementGroupInput>
            <AddApartmentLabel htmlFor="pic.role" isRequired>
              PIC Role
            </AddApartmentLabel>
...
Information.getLayout = getAddApartmentLayout
