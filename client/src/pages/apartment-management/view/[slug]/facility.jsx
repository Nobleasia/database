...
const Facility = () => {
  ...
  const facilities = useMemo(() => {
    return apartmentAttributes?.facilities.map(
      ({ property_facility_name: propertyFacilityName }) => propertyFacilityName
    );
  }, [apartmentAttributes?.facilities]);

  return (
    <section className="flex flex-col gap-4">
      <h3 className="text-lg font-semibold">
        Facilities available in this Apartment:
      </h3>
...
Facility.getLayout = getViewApartmentLayoutProps;
