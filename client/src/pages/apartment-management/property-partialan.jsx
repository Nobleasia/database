...
const PropertyPartialan = ({ columns }) => {
  ...
  const { datas } = useDatasFetcher(selectedKodeProparDebounce, "apartment")
  ...
  const handlePublicLink = async () => {
    ...
    // Validation rules
    const requiredColumns = ["name", "rental_price", "selling_price"]
  ...
  return (
    <>
      <Head>
        <title>
          Apartement Management | Noble Asia Database Management System
        </title>
      </Head>
