...
const Information = ({ available }) => {
  ...
  return (
    <>
      <ApartmentManagementGroupInput>
        <AddApartmentLabel htmlFor="kodePropar" isRequired>
          Kode Propar
        </AddApartmentLabel>
        <Controller
          control={control}
          ...
          render={({ field, fieldState: { isTouched, error } }) => (
            <>
              ...
              {error ? (
                ...
                <ApartmentManagementCustomPlaceholder ariaPlaceholder="Example: Ampera Apartment">
      ...
      <ApartmentManagementGroupInput>
        <AddApartmentLabel htmlFor="availability">
          Availability
        </AddApartmentLabel>
...
Information.getLayout = getEditApartmentLayout
