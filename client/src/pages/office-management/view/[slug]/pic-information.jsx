...
const PicInformation = () => {
  ...
  return (
    <section className="flex flex-col gap-4">
      <h3 className="text-lg font-semibold">PIC in this Office:</h3>

      <div className="flex flex-col gap-8">
        <div className="flex flex-col gap-2 font-medium text-neutral-900">
          <h4 className="text-npa-neutral-500">Name</h4>
          <p>{officeAttributes?.property_person_in_charge?.fullname}</p>
        </div>
        ...
        <div className="flex flex-col gap-2 font-medium text-neutral-900">
          ...
          <p>
            {
              officeAttributes?.property_person_in_charge
        ...
        <div className="flex flex-col gap-2 font-medium text-neutral-900">
          ...
          <p>{officeAttributes?.property_person_in_charge?.phone_number}</p>
        </div>
      </div>
    </section>
  )
...
PicInformation.getLayout = getViewOfficeLayoutProps
