...
const Information = ({ available }) => {
  ...
  return (
    <>
      <OfficeManagementGroupInput>
        <AddOfficeLabel htmlFor="kode_propar" isRequired>
          Kode Propar
        </AddOfficeLabel>
        <Controller
          control={control}
            ...
            return (
              <>
                ...
                {error ? (
                  ...
                  <OfficeManagementCustomPlaceholder ariaPlaceholder="Example: AMP001">
                    Example: AMP001
                  </OfficeManagementCustomPlaceholder>
                )}
              </>
      ...
      <OfficeManagementGroupInput>
        <AddOfficeLabel htmlFor="size">Building Completion</AddOfficeLabel>
        <Controller
          control={control}
          name="size"
          render={({ field, fieldState: { isTouched, error } }) => (
      ...
      <OfficeManagementGroupInput>
        ...
        <Controller
          ...
          rules={{
            pattern: {
              value: /^[a-zA-Z0-9 ]+$/g,
              message: "Certificates must not contain special characters",
            },
          }}
          render={({ field, fieldState: { isTouched, error } }) => (
            <>
              <InputField
                ...
                type="text"
                id="certificates"
                placeholder="Office certificates"
                disabled={isSubmitting}
                isSubmitted={isSubmitted}
                isTouched={isTouched}
                isError={error}
                onChange={(event) => {
                  ...
                  if (isCustomInvalid) {
                    setError("name", {
                      type: "custom",
                      message:
                        "Certificates must not contain special characters",
                    })
                  } else {
                    clearErrors("name")
                  }
              ...
              {error ? (
                ...
                <OfficeManagementCustomPlaceholder ariaPlaceholder="Example: -">
                  Example: -
                </OfficeManagementCustomPlaceholder>
              )}
            </>
      ...
      <OfficeManagementGroupInput>
        <AddOfficeLabel htmlFor="available">Availability</AddOfficeLabel>
...
Information.getLayout = getAddOfficeLayout
