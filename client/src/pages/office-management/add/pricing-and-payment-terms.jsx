    ...
    <>
      <section className="flex flex-col gap-4">
        ...
        <OfficeManagementGroupInput>
          ...
          <Controller
            control={control}
            name="fees.security_deposit"
            render={({ field, fieldState: { isTouched, error } }) => (
              <>
                <InputField
                  {...field}
                  type="text"
                  id="fees.security_deposit"
...
PricingAndPaymentTerms.getLayout = getAddOfficeLayout
