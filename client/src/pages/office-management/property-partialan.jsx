...
const PropertyPartialan = ({ columns }) => {
  ...
  const { datas } = useDatasFetcher(selectedKodeProparDebounce, "office")
...
export async function getServerSideProps() {
  return {
    props: {
      columns: [
        { id: "buildingName", value: "name", label: "Building Name" },
        { id: "address", value: "address", label: "Address" },
        {
          id: "buildingCompletion",
          value: "building_completion",
        ...
        {
          id: "serviceCharge",
          value: "service_charge_details",
          label: "Service Charge Details",
        },
        {
          id: "overtime",
          value: "overtime_details",
        ...
        {
          id: "leaseTerms",
          value: "lease_term_details",
          label: "Lease Terms Details",
        },
        { id: "facilities", value: "facilities", label: "Facilities" },
        { id: "parkingRatio", value: "parking_ratio", label: "Parking Ratio" },
