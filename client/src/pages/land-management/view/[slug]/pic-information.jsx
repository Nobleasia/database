    ...
    <section className="flex flex-col gap-4">
      ...
      <div className="flex flex-col gap-8">
        ...
        <div className="flex flex-col gap-2 font-medium text-neutral-900">
          ...
          <p>
            {
              landAttributes?.property_person_in_charge
        ...
        <div className="flex flex-col gap-2 font-medium text-neutral-900">
          ...
          <p>{landAttributes?.property_person_in_charge?.phone_number}</p>
        </div>
      </div>
    </section>
  )
...
PicInformation.getLayout = getViewLandLayoutProps
