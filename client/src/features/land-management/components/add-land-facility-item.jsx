...
import { AddLandLabel } from "./add-land-label";

export const AddLandFacilityItem = ({
  index,
  control,
  isSubmitting,
  isSubmitted,
  ...
  return (
    <div className="grid w-[100%] grid-cols-1 grid-rows-3 items-center gap-4 lg:grid-cols-3 lg:grid-rows-1">
      <GroupInput direction="column">
        <AddLandLabel htmlFor={`facilities.${index}.propertyFacilityName`}>
          Facility Name
        </AddLandLabel>
      ...
      <GroupInput direction="column">
        <AddLandLabel htmlFor={`facilities.${index}.type`}>
          Facility Type
        </AddLandLabel>
        <Controller
          control={control}
      ...
      <GroupInput direction="column">
        <AddLandLabel htmlFor={`facilities.${index}.unit`}>
          Facility Unit
        </AddLandLabel>
        <Controller
          control={control}
