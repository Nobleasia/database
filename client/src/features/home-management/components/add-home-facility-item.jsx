...
import { AddHomeLabel } from "./add-home-label";

export const AddHomeFacilityItem = ({
  index,
  control,
  isSubmitting,
  isSubmitted,
  ...
  return (
    <div className="grid w-[100%] grid-cols-1 grid-rows-3 items-center gap-4 lg:grid-cols-3 lg:grid-rows-1">
      <GroupInput direction="column">
        <AddHomeLabel htmlFor={`facilities.${index}.propertyFacilityName`}>
          Facility Name
        </AddHomeLabel>
      ...
      <GroupInput direction="column">
        <AddHomeLabel htmlFor={`facilities.${index}.type`}>
          Facility Type
        </AddHomeLabel>
        <Controller
          control={control}
      ...
      <GroupInput direction="column">
        <AddHomeLabel htmlFor={`facilities.${index}.unit`}>
          Facility Unit
        </AddHomeLabel>
        <Controller
          control={control}
