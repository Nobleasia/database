...
export const AddPicCompanyDialog = ({
  id,
  name,
  isEditMode,
  mutateDataOrigin,
  ...
  const onSubmit = async (payload) => {
    const successMessage = isEditMode
      ? "Success update PIC company"
      : "Success add new PIC company";
    const ENDPOINT = isEditMode
      ? `${process.env.NEXT_PUBLIC_ENDPOINT_PIC_COMPANIES_UPDATE}/${id}`
      : `${process.env.NEXT_PUBLIC_ENDPOINT_PIC_COMPANIES_CREATE}`;
        ...
        <DialogContent className="flex flex-col gap-5 overflow-y-auto" asChild>
          ...
          >
            <div className="flex items-center justify-between border-b-1 border-b-npa-neutral-300 pb-2">
              <DialogTitle>Add PIC Company</DialogTitle>
            ...
            <div className="flex flex-col gap-4">
              <GroupInput direction="column">
                ...
                <Controller
                  ...
                  control={control}
                  rules={{
                    required: "PIC company name is required",
                  }}
