...
import { AddApartmentLabel } from "./add-apartment-label";

export const AddApartmentFacilityItem = ({
  index,
  control,
  isSubmitting,
  isSubmitted,
  ...
  return (
    <div className="grid w-[100%] grid-cols-1 grid-rows-3 items-center gap-4 lg:grid-cols-3 lg:grid-rows-1">
      <GroupInput direction="column">
        <AddApartmentLabel htmlFor={`facilities.${index}.propertyFacilityName`}>
          Facility Name
        </AddApartmentLabel>
      ...
      <GroupInput direction="column">
        <AddApartmentLabel htmlFor={`facilities.${index}.type`}>
          Facility Type
        </AddApartmentLabel>
        <Controller
          control={control}
      ...
      <GroupInput direction="column">
        <AddApartmentLabel htmlFor={`facilities.${index}.unit`}>
          Facility Unit
        </AddApartmentLabel>
        <Controller
          control={control}
