...
export const ApartmentTableControl = ({
  ...
  const columnsData = useApartmentTableColumns({
    handleToggleToast,
    handleDeleteApartment,
  })
  ...
  return (
    <>
      {data.length <= 0 && !isLoading ? (
        ...
        <ApartmentTable isLoading={isLoading} table={table} />
      )}
