...
export const OfficeTableControl = ({
  ...
  const columnsData = useOfficeTableColumns({
    handleToggleToast,
    handleDeleteOffice,
  })
  ...
  return (
    <>
      {data.length <= 0 && !isLoading ? (
        ...
        <OfficeTable isLoading={isLoading} table={table} />
      )}
